//
//  ListBusesTravelOptionsPresenter.swift
//  MyTravel
//
...
public class ListBusesTravelOptionsPresenter: ListTravelOptionsInteractorDelegate, ListTravelOptionsPresenterProtocol {
    ...
    public func getTravelOptions() {
        ...
        interactor.doListTravelOptions(travelMode: .bus)
    }
