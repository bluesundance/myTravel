//
//  ListFlightsTravelOptionsPresenter.swift
//  MyTravel
//
...
public class ListFlightsTravelOptionsPresenter: ListTravelOptionsInteractorDelegate,
ListTravelOptionsPresenterProtocol {
    ...
    public func getTravelOptions() {
        ...
        interactor.doListTravelOptions(travelMode: .flight)
    }
    ...
    public func didGetTravelOptions(travelOptions options: [TravelOption], forTravelMode mode: TravelMode) {
        ...
        DispatchQueue.main.async(execute: {
            self.delegate?.didGetTravelOptions(withTravelOptions: self.travelOptions)
        })
    }
